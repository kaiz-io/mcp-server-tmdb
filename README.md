...
[![smithery badge](https://smithery.ai/badge/mcp-server-tmdb)](https://smithery.ai/server/mcp-server-tmdb)
...
```bash
npx -y @smithery/cli install mcp-server-tmdb --client claude
```
